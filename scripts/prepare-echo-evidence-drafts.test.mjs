...
test('prepares draft evidence manifests without marking external evidence complete', async () => {
  ...
  assert.match(caseStudyKo, /\uD575\uC2EC \uACB0\uACFC \uC9C0\uD45C/);
  assert.match(caseStudyKo, /Conversation Recovery Rate \(8\uCD08\)/);
  assert.match(caseStudyKo, /Independent Transfer Rate Day 1/);
  assert.match(caseStudyKo, /Independent Transfer Rate Day 7/);
  assert.match(caseStudyKo, /Transfer scenario count/);
  ...
  assert.match(caseStudyEn, /Core Outcome Metrics/);
  assert.match(caseStudyEn, /Conversation Recovery Rate \(8-second window\)/);
  assert.match(caseStudyEn, /Independent Transfer Rate Day 1/);
  assert.match(caseStudyEn, /Independent Transfer Rate Day 7/);
  assert.match(caseStudyEn, /Transfer scenario count/);
