...
async function main() {
  ...
  await validateFinalManifest({
    ...
    issue: '#29',
    missingDetail: 'Missing docs/project-echo-chatgpt-action-evidence.completed.json with deployed Custom GPT Action/OAuth endpoint proof, privacy rejection evidence, same .ehpk build-artifact hash, calibrated G2/audio-level active-recall pronunciation evidence, and spaced-recall transfer evidence.',
  });
