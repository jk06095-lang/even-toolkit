...
export function renderQaExportMarkdown(summary) {
  const lines = [
    ...
    '## Overall',
    '',
    '| Segment | Sessions | G2 mic | Phone fallback | Cue p50 | Cue p95 | Cue max | Cue used | Cue dismissed | False cues | Avg silence | Self response |',
    '| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |',
    `| ${renderSummaryRow('All sessions', summary.overall)} |`,
    '',
    '## By Category',
    '',
    '| Category | Sessions | G2 mic | Phone fallback | Cue p50 | Cue p95 | Cue max | Cue used | Cue dismissed | False cues | Avg silence | Self response |',
    '| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |',
    ...summary.byCategory.map((row) => `| ${renderSummaryRow(row.category, row)} |`),
    '',
    '## By Topic',
    '',
    '| Topic | Sessions | G2 mic | Phone fallback | Cue p50 | Cue p95 | Cue max | Cue used | Cue dismissed | False cues | Avg silence | Self response |',
    '| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |',
